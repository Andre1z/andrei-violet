...
class Bot:
    def __init__(self, x, y, angle, sensor_angles=None, sensor_range=None, bot_radius=None, sensor_weights=None, bias=None):
        ...
        # sensor_angles es una lista de offsets (en radianes) relativos al ángulo actual del robot.
...
def main():
    ...
    while running:
        ...
        if winner is not None:
            ...
            # Cada 20 generaciones, aumentar el tamaño del laberinto (pantalla) en 100 píxeles en ambas dimensiones.
            if generation % 2 == 0:
                SCREEN_WIDTH += 10
                SCREEN_HEIGHT += 10
                screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
